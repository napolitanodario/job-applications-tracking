...
`applications.csv` is generated from Gmail **Updates** (`category:updates`). Latest refresh: **2026-08-19 23:17 UTC**.
...
This hourly run found **no new application or outcome emails** after 2026-08-18 (Bending Spoons screening/task invite).
